...
export function AcceptTerms(): JSX.Element {
...
export function BasicCheckbox(): JSX.Element {
  return <HStack space={6}>
...
export function Uncontrolled(): JSX.Element {
...
export function SizeCheckbox(): JSX.Element {
  return <Center>
    <VStack space={3}>
...
export function CheckboxGroup(): JSX.Element {
  const [ groupValue, setGroupValue ] = useState<string[]>(["Photography", "Gardening"]);
...
export function FormControlled(): JSX.Element {
  const [ groupValue, setGroupValue ] = useState<string[]>(["Phone", "Email"]);
...
export function CheckboxWithRef(): JSX.Element {
  const myRef: any = useRef();
  const [ bg, setBg ] = useState<string>("#fa000050");
