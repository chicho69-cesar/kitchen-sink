...
export function SizesButton(): JSX.Element {
  return <VStack space={4} alignItems="center">
    {[ "xs", "sm", "md", "lg" ].map((size: string) => (
...
function ButtonsElements({ variant }: any): JSX.Element {
...
function StackElement({ children }: Props) {
  return <Stack mb="2.5" mt="1.5">
    {children}
  </Stack>;
}

export function ButtonVariants(): JSX.Element {
...
export function LoadingButtons(): JSX.Element {
  return <Stack 
    direction={{
      base: "column",
      md: "row"
