...
export function BasicSlider(): JSX.Element {
...
export function ColorSlider(): JSX.Element {
  return <Box alignItems="center" w="100%">
...
export function ValueSlider(): JSX.Element {
  const [ onChangeValue, setOnChangeValue ] = useState<number>(70);
  const [ onChangeEndValue, setOnChangeEndValue ] = useState<number>(70);
...
export function SizeSlider(): JSX.Element {
  return <Box alignItems="center" w="100%">
...
export function CustomisedSlider(): JSX.Element {
  return <Box alignItems="center" w="100%">
...
export function FormControlledSlider(): JSX.Element {
  return <Box alignItems="center" w="100%">
    <VStack space={4} w="75%" maxW="300">
