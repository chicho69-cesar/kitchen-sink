...
export function BasicIconButton(): JSX.Element {
...
export function SizesIconButton(): JSX.Element {
  return <Center>
...
export function VariantsIconButton(): JSX.Element {
  return <Center>
    <VStack space={4} alignItems="center">
      {[ "outline", "solid", "ghost" ].map((variant: string) => 
