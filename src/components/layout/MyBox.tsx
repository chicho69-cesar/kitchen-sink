...
export function BasicExtended(): JSX.Element {
  return <>
    <Box 
      p="2" bg="primary.500" 
      _text={{
...
const LinearGrandientExpo = (): JSX.Element => {
  return <Box 
    bg={{
      linearGradient: {
...
export function WithLinearGradientExpo(): JSX.Element {
...
const LinearGradientNative = (): JSX.Element => {
  return (
    <Box
      bg={{
        linearGradient: {
...
export function WithLinearGradientNative(): JSX.Element {
  return (
...
export function WithRef(): JSX.Element {
