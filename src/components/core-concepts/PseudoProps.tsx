...
export function HoverProps():  JSX.Element {
  const {
    isOpen,
    onOpen,
    onClose
...
export function PressedProps(): JSX.Element {
  const {
    isOpen,
    onOpen,
    onClose
...
export function FocusProps(): JSX.Element {
  const {
    isOpen,
    onOpen,
    onClose
...
export function PlatformSpecificStyling(): JSX.Element {
  const {
    isOpen,
    onOpen,
    onClose
