...
export function DividerExample(): JSX.Element {
...
export function DividerBasic(): JSX.Element {
  return <Box alignItems="center">
    <Box w="140">
...
export function DividerOrientation(): JSX.Element {
  return <Box alignItems="center">
    <Box w="160">
...
export function CompositionDivider(): JSX.Element {
  return <Box alignItems="center">
    <Flex direction="row" h="58" p="4">
      <Text>Simple</Text>
      <Divider bg="emerald.500" thickness="2" mx="2" orientation="vertical" />
