...
export function ColorSchemaBadge(): JSX.Element {
  return <HStack 
    space={{ base: 2, sm: 4 }} 
    mx={{ base: "auto", md: 0 }}
  >
...
export function VariantBadges(): JSX.Element {
  return <Box alignItems="center">
    <HStack space={4} mx={{ base: "auto", md: "0" }}>
      {[ "solid", "outline", "subtle" ].map((key: string) => {
...
export function CompositionBadge(): JSX.Element {
  ...
  return <Box alignItems="center">
    <VStack>
      ...
      <Button 
        ...
        onPress={(): void => setNotifications(notifications + 1)}
      >
        Notifications
      </Button>
    </VStack>
