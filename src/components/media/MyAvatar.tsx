...
export function BasicAvatar(): JSX.Element {
...
export function SizesAvatar(): JSX.Element {
  return <Center>
    <VStack 
      space={2} alignItems={{
        base: "center",
...
export function FallbacksAvatar(): JSX.Element {
  return <HStack 
...
export function AvatarGroup(): JSX.Element {
  return <Center>
    <Avatar.Group 
      _avatar={{
        size: "lg"
