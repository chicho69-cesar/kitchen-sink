...
export function BasicImage(): JSX.Element {
  return <Center>
    <Image 
      source={{
...
export function ImageSizes(): JSX.Element {
  return <>
    ...
    <ScrollView>
      ...
      >
        {[ "xs", "sm", "md", "lg", "xl", "2xl" ].map((size: string): JSX.Element => 
          <Image 
...
export function BorderRadiusImage(): JSX.Element {
  return <Center>
    <Image 
...
export function FallbackImage(): JSX.Element {
  return <Center>
    <Image 
...
export function ImageWithRef(): JSX.Element {
