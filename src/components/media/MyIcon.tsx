...
export function BasicIcon(): JSX.Element {
...
export function NativeBaseIcons(): JSX.Element {
  ...
  return <Box w="100%">
    <FlatList 
      data={icons} 
      renderItem={({ item }: { item: Icons }) => <VStack 
...
export function CreateIcon(): JSX.Element {
...
export function ThirdPartyIcons(): JSX.Element {
  return <Center>
    <HStack space={3}>
      <Icon 
        as={AntDesign} 
