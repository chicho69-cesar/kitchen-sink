...
export function BasicSlide(): JSX.Element {
  const [ isOpenTop, setIsOpenTop ] = useState<boolean>(false);
...
export function SlideWrapped(): JSX.Element {
...
export function SlideComposition(): JSX.Element {
  const [ isOpen, setIsOpen ] = useState<boolean>(false);
