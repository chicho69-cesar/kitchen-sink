import { useDisclose, Button, Icon, Actionsheet, Text, Box, Center } from "native-base";
import { MaterialIcons, Ionicons } from "@expo/vector-icons";
import { Path } from "react-native-svg";

export function BasicActionSheet(): JSX.Element {
  const {
    isOpen,
    onOpen,
    onClose
...
export function CompositionActionSheet(): JSX.Element {
  const {
    isOpen,
    onOpen,
    onClose
...
export function DisableOverlayActionSheet(): JSX.Element {
  const {
    isOpen,
    onOpen,
    onClose
...
export function IconsActionSheet(): JSX.Element {
  const {
    isOpen,
    onOpen,
    onClose
