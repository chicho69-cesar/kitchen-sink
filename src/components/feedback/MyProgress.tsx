...
export function BasicProgress(): JSX.Element {
  return <Center w="100%">
    <Box w="90%" maxW="400">
...
export function ProgressColorSchema(): JSX.Element {
  return <Center w="100%">
    <Box w="90%" maxW="400">
      <VStack space="md">
...
export function SizesProgress(): JSX.Element {
  return <Center w="100%">
    <Box w="90%" maxW="400">
      <VStack space="md">
        <VStack mx="4" space="md">
...
export function FlatProgress(): JSX.Element {
  return <Center w="100%">
    <Box w="90%" maxW="400">
...
export function CustomTrackColor(): JSX.Element {
  return <Center w="100%">
    <Box w="90%" maxW="400">
      <Progress 
        bg="coolGray.100" 
