...
export function BasicSkeleton(): JSX.Element {
  return <Center w="100%">
    <VStack 
      w="90%" maxW="400" borderWidth="1" 
      space={8} overflow="hidden" rounded="md" 
...
export function ColorSkeleton(): JSX.Element {
  return <Center w="100%">
    <HStack 
      w="90%" maxW="400" borderWidth="1" 
...
export function CompositionSkeleton(): JSX.Element {
  return <Center w="100%">
    <VStack 
      w="90%" maxW="400" borderWidth="1" 
...
export function SkeletonIsLoaded(): JSX.Element {
