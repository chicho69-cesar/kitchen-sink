...
const NBBox1 = (props: any): JSX.Element => {
  return <Box borderRadius="md" bg="primary.600" {...props} />;
}

export function MarginAndPadding(): JSX.Element {
  return <>
    <NBBox1 m="2" p="5" />
...
const NBBox2 = (props: any): JSX.Element => {
  return <Box p="5" m="2" borderRadius="md" bg="primary.200" {...props} />;
}

export function ColorAndBackground(): JSX.Element {
  return <>
    <NBBox2 bg="#10b981" />
...
export function UPTypography(): JSX.Element {
...
const NBText = (props: any): JSX.Element => {
  return <Text m="2" {...props} />;
}

export function UPText(): JSX.Element {
  return <>
...
const NBBox3 = (props: any): JSX.Element => {
  return <Box m="2" borderRadius="md" bg="primary.600" {...props} />;
}

export function LayoutWidthAndHeight(): JSX.Element {
  return <>
...
const NBBox4 = (props: any): JSX.Element => {
  return <Box p="5" m="2" borderRadius="md" bg="primary.600" {...props} />;
}

export function UPFlexbox(): JSX.Element {
  return <>
...
const NBBox5 = (props: any): JSX.Element => {
  return <Box p="5" m="2" borderRadius="md" bg="primary.200" {...props} />;
}

export function UPBorders(): JSX.Element {
  return <>
...
const NBBox6 = (props: any): JSX.Element => {
  return <Box p="5" m="2" bg="primary.500" {...props} />;
}

export function UPBordersRadius(): JSX.Element {
  return <>
...
const NBBox7 = (props: any): JSX.Element => {
  return <Box p="5" borderRadius="md" bg="primary.400" {...props} />;
}

export function UPPosition(): JSX.Element {
...
const NBBox8 = (props: any): JSX.Element => {
  return <Box p="5" m="2" borderRadius="md" bg="primary.500" {...props} />;
}

export function UPShadow(): JSX.Element {
  return <>
    <NBBox8 shadow="1" />
    <NBBox8 shadow="3" />
    <NBBox8 shadow="5" />
...
export function InternalProps(): JSX.Element {
  return <Button _text={{
    color: "primary.100",
    fontSize: "md",
    fontWeight: "bold",
...
export function InteractionProps(): JSX.Element {
