...
export function BasicHidden(): JSX.Element {
  return <Hidden>
    <Box bg="red.400" p="2">
...
export function HiddenBreakpoints(): JSX.Element {
  return <>
...
export function HiddenColorMode(): JSX.Element {
  const {
    toggleColorMode
  } = useColorMode();
...
export function HiddenPlatform(): JSX.Element {
