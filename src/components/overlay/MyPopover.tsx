...
export function BasicPopover(): JSX.Element {
...
export function PopoverFocusRef(): JSX.Element {
  const initialFocusRef: any = useRef(null);
...
export function PositionsPopover(): JSX.Element {
