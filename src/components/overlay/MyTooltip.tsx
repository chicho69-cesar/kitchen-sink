import { Center, Tooltip, Button, VStack, Select, CheckIcon } from 'native-base';
import { useState } from 'react';

export function BasicTooltip(): JSX.Element {
  return <Center>
...
export function PositionsTooltip(): JSX.Element {
  const [ position, setPosition ] = useState<any>("top left");
...
export function CustomisingTooltip(): JSX.Element {
  return <Center>
    <Tooltip 
      label="Click here to read more" 
      openDelay={500} bg="indigo.500" 
      _text={{ color: "#fff" }}
    >
      <Button>More</Button>
    </Tooltip>
